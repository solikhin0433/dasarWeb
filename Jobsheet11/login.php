...
<head>
    ...
    <title>Aplikasi Kantor Solikhin</title>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
        <symbol id="check2" viewBox="0 0 16 16">
            <path
                d="M13.854 3.646.5.500 10.7081-7 7a.5.5 0 0 1-.708 01-3.5- 3.5.5.5 1 1.708-.708L6.5 10.29316.646-6.6478.5.500 1.7 08 02">
            </path>
        </symbol>
        ...
        <symbol id="moon-stars-fill" viewBox="0 16 16">
            <path
                d="M6.278.768.768 01.08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 01.04.055 1.533-.16.787. 787 1.81.316.733.733 001-.031.8938.349 8.349 0 0 18. 344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124 .06 A.752.752 0 0 1 6.2782">
            </path>
            <path
                d="M10.794 3.148a.217.217 01.412 01.387 1.162c.173.518.579. 974 1.097 1.89711.162.387a.217.217 10.4121-1.162.387a1. 734 1.7340-1.097 1.0971-.387 1.162.217.217 0 0 1-412 0 1-387-1.162A1.734 1.734 9.31 6.5931-1.162-.387.217.21 70 010-41211.162-.387a1.734 1.734 01.097-1.0971.387- 1.162zM13.863.099a.145.145 01.274 01.258.774c.115.346.38 6.617.732.7321.774.258.145.145 01 0.2741-.774.258a1.156 1.156 000-.732.7321-.258.774.145.145 001-.274 01-258-.7 741.156 1.156 000-.732-7321-.774-.2580.145.145 01 0-2 741.774-.258c.346-.115.617-.386.732-732L13.863.1z">
            </path>
        </symbol>
        <symbol id="sun-fill" viewBox="0 0 16 16">
            <path
                d="M8 1284 4 0 1 0 0-8 440000 828 0.5.500 1.5.5v2.5. 500 1-1 @v-24.5.5 0 0 1 8 0zmo 138.5.500 1.5.5v2.5.5 0 01-10V-24.5.5 18 137m8-5a.5.5 0 0 1-.5.5h-2a.5.500 1 -1h2a.5.5 @ 1.5.573 83.5.50 @ 1-.5.5h-2a.5.5 @@ 10-1h 2A.5.50 1 3 8rm10.657-5.657.5.5 0 0 10.7071-1.414 1.415 a.5.5 1 1.707-.70811.414-1.414.5.500 1.707 0zm-9.193 9.193.5.50 10.707L3.05 13.657a.5.5001-.707-.70711.41 4-1.414.5.500 1.707 0zm9.193 2.121.5.5 0 0 1-.707 01-1.4 14-1.414.5.5 1.707-.7071.414 1.4148.5.50 1.7072M 4.464 4.465.5.5 1.707 0L2.343 3.05 .5.50 11.707--707 1.414 1.4148.5.50 10.7082">
            </path>
        </symbol>
    </svg>
