...
include "fungsi/pesan_kilat.php"; //  fungsi untuk menampilkan pesan
include "fungsi/anti_injection.php"; //  fungsi untuk mencegah serangan SQL Injection
...
if ($result) {
    ...
    mysqli_close($koneksi); // untuk Menutup koneksi database
    $salt = $row['salt'];
