...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css"
        integrity="sha384-fnmDCqbTlwilj8lyTjo7mOUStjsKC4pQpQbqyi7RrhN7udi9RwhKkMHpvl.bHG9Sr" crossorigin="anonymous">
    <!-- Datatable -->
...
<body>
    ...
    $("#simpan").click(function() {
        ...
        if (document.getElementById("jenkel1").checked == false && document.getElementById("jenkel2").checked ==
            false) {
